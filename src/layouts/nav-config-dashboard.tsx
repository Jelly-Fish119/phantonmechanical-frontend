   ...
   */
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ICONS.project,
        children: [
          { title: 'Ongoing projects', path: paths.dashboard.project.root },
          { title: 'Create Project', path: paths.dashboard.project.new },
          // { title: 'Sent Quotes', path: paths.dashboard.project.details(MOCK_ID) },
          // { title: 'Approved/Declined Quotes', path: paths.dashboard.project.edit(MOCK_ID) },
        ],
      },
      {
        title: 'Order',
